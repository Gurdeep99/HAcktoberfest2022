                    ...
                    <div class="transport-viewer clearfix">
                        <div class="mod-register">
                            ...
                            <div class="wrap-form-reg clearfix">
                                <form action="component/formConnect.php" method="POST" >
                                    <div class="left-form">
                                        <label class="wrap-txt" for="sys_email">
                                            <input class="input-txt" id="sys_email" type="email" name="loginUser" placeholder="you@mail.com">
                                        </label>
                                        <label class="wrap-txt" for="sys_pass">
                                            <input class="input-txt" id="sys_pass" type="password" name="loginpassword" placeholder="password please!">
                                        </label>
